...
def test_netcdf_tools():
    ...
    geomatics.convert.netcdf_to_geotiff(netcdf_files, 'Tair_f_inst', save_dir='/Users/riley/spatialdata/tmpdir/',
                                        x_var='lat', y_var='lon')
    print(ts_nc_pt)
    print(ts_nc_bx)
    print(ts_nc_shp)
...
def test_grib_tools():
    ...
    ts_gb_pt = geomatics.timedata.point_series(grib_files, 'al', pt_coords, x_var='longitude', y_var='latitude',
                                               xr_kwargs=xr_kwargs)
    ts_gb_bx = geomatics.timedata.box_series(grib_files, 'al', bx_coords, x_var='longitude', y_var='latitude',
                                             xr_kwargs=xr_kwargs)
    ts_gb_shp = geomatics.timedata.shp_series(grib_files, 'al', shp_path, x_var='longitude', y_var='latitude',
                                              xr_kwargs=xr_kwargs)
    print(ts_gb_pt)
    print(ts_gb_bx)
    print(ts_gb_shp)
...
def test_hdf5_tools():
    ...
    ts_h5_pt = geomatics.timedata.point_series(hdf5_files, 'Soil_Moisture_Retrieval_Data_1km/soil_moisture_1km',
                                               coords=(41, -112),
    ...
    ts_h5_bx = geomatics.timedata.box_series(hdf5_files, 'Soil_Moisture_Retrieval_Data_1km/soil_moisture_1km',
                                             coords=((-115, 40), (-110, 45)),
                                             x_var='Soil_Moisture_Retrieval_Data_1km/latitude_1km',
                                             y_var='Soil_Moisture_Retrieval_Data_1km/longitude_1km',
                                             t_var='a/rangeBeginningDateTime')
    ts_h5_shp = geomatics.timedata.shp_series(hdf5_files, 'Soil_Moisture_Retrieval_Data_1km/soil_moisture_1km',
